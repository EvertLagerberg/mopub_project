...
<script type="text/javascript"
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOgf60Bt5Zk7eIz-eApBBXlVEcEsuOg6M&sensor=true"></script>
...
<body onload="start()">
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">School Day</a>
			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">

					<li class="active"><a id="map" href="#">Home</a></li>
					<li><a id="Update" href="#update"><span
		...
		<div class="container">
			<div class="row" id="routebar">
				<div class="text-center">
					<p>
						<b>Chosen route:</b> <span id="total" class="small">-- </span> <span
							id="duration" class="small">--</span>
					</p>
				</div>
			</div>
			<div class="row toolbar">
				...
				<div class="col-xs-3">
					<button onclick="Route(null,null)"
						class="btn btn-primary btn-md center-block" id="route">Route</button>
		...
		<div class="container theme-showcase">
			<div class="page">
				<div class="jumbotron">
					...
					<h2>Add calendar</h2>
					<p>Enter the URL to your KTH schedule here. Once you have
						entered your URL , your scheduled events will appear on the map.
						To update your schedule, just enter the link again.</p>

					<form role="form" action="/intprog_project/EventController"
						method="POST">
						<input type="hidden" name="action" value="addUrl"> <label
							for="URL">Schedule URL:</label> <input type="url"
							class="form-control" id="URL" name="url" value="">
	...
	<div id="about">
		<div class="container">
			<div class="page">
				...
				<p class="lead">This web app was made as a project in the course
					Mobile development with web technologies (DM2518) Kungliga Tekniska
					Högskolan,KTH</p>

				<div class="well well-sm">
					<p>
						The idea of the site is to use the <a
							href="https://www.kth.se/social/">KTH Social</a> schedule service
						to easily find the location for every event and quickly get a
						quick overview of all the events for a day of lectures, seminars
						and labs at KTH Campus.
					</p>

					<p>After exporting your KTH Schedule into this web page, you
						will be able to see all the events of your school day. You can see
						the exact location for each event, and load a route on how to get
						there from your current location.</p>

					<p>Today the service is limited to KTH , but it could easily
						expand to other organizations as well</p>
	...
	<script>
		var routeON = false;
		var list = new Array();
		var timeNow = startTime(); //enhetens tid
		var myDate; //dagens datum som sätts i startTime()
		console.log("this is the client time " + timeNow);

		//daylist är en array med bönor av varje event. Dessa görs om till javascript objekt som läggs in i arrayen list
		...
		function initialize() {
			...
			for (var i = 0; i < list.length; i++) { //markers skapas för listans alla objekt, specialfall hanteras
				console.log("namn " + list[i].name);
				...
				if (list[i].room === "Saknas") {
					var icon = {
						...
						scaledSize : new google.maps.Size(65, 62)
					// size
					};
				...
				if (i == 0) { //första marker sätts till att hoppa
					...
					if (markerTimeNow < markerTimeBefore) { //om starttid är innan sluttid så sker en schemakrock
						eventOverlap(marker);
		...
		function checkTime(i) { // adds zeros in front of numbers < 10
			if (i < 10) {
				i = "0" + i;
			}
			;
